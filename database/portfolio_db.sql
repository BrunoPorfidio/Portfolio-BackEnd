...
-- -----------------------------------------------------
-- Schema Portfolio_mydb
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema Portfolio_mydb
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `Portfolio_mydb` DEFAULT CHARACTER SET utf8 ;
USE `Portfolio_mydb` ;

-- -----------------------------------------------------
-- Table `Portfolio_mydb`.`Persona`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Portfolio_mydb`.`Persona` (
...
-- -----------------------------------------------------
-- Table `Portfolio_mydb`.`Experiencia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Portfolio_mydb`.`Experiencia` (
  ...
  CONSTRAINT `fk_Experiencia_Persona1`
    ...
    REFERENCES `Portfolio_mydb`.`Persona` (`id` , `Usuario_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Portfolio_mydb`.`Educacion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Portfolio_mydb`.`Educacion` (
  `idEducacion` INT NOT NULL,
  `intitucion` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `Portfolio_mydb`.`Proyectos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Portfolio_mydb`.`Proyectos` (
...
-- -----------------------------------------------------
-- Table `Portfolio_mydb`.`Skills`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Portfolio_mydb`.`Skills` (
...
-- -----------------------------------------------------
-- Table `Portfolio_mydb`.`rol`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Portfolio_mydb`.`rol` (
  `id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `Portfolio_mydb`.`Usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Portfolio_mydb`.`Usuario` (
  `id` INT NOT NULL,
  `nombre` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `Portfolio_mydb`.`Usuario_has_rol`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Portfolio_mydb`.`Usuario_has_rol` (
  ...
  CONSTRAINT `fk_Usuario_has_rol_Usuario1`
    ...
    REFERENCES `Portfolio_mydb`.`Usuario` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Usuario_has_rol_rol1`
    FOREIGN KEY (`rol_id`)
    REFERENCES `Portfolio_mydb`.`rol` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
